...
we create sortable columns with wx.lib.mixins.listctrl.ColumnSorterMixin
...
class SortedListCtrl(wx.ListCtrl, wx.lib.mixins.listctrl.ListCtrlAutoWidthMixin, wx.lib.mixins.listctrl.ColumnSorterMixin):
